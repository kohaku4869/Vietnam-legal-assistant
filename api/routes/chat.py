...
# # SỬA Ở ĐÂY: Truyền toàn bộ đối tượng 'embedder'
# vector_db = VectorDB(embedder) # <--- THAY ĐỔI QUAN TRỌNG
# reranker = Reranker()
...
#             # In ra lỗi chi tiết hơn để gỡ lỗi
#             print(f"Error building vector store for {category}: {e}")
